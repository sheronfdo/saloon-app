...
import 'package:saloon_app/screens/User/flow/bookings/booking_details/bookingdetailsviewmodel.dart';
...
class BookingDetailsState extends State<BookingDetailsView> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          minimumSize: Size(double.infinity,
                              0), // Set the button to full width
                        ),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: const [
                      ...
                      ElevatedButton(
                        ...
                        child:
                            Text('Reschedule', style: TextStyle(fontSize: 16)),
                      ),
                      SizedBox(height: 12),
                      OutlinedButton(
                        onPressed: () {},
                        style: OutlinedButton.styleFrom(
                          side: BorderSide(color: Color(0xFFBF4011)),
                        ...
                        child: Text(
                          'Cancel Appointment',
                          style:
                              TextStyle(color: Color(0xFFBF4011), fontSize: 16),
                        ),
                      ),
                    ],
                  ),

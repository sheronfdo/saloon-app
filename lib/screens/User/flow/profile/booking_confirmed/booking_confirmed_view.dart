...
import 'package:saloon_app/screens/User/flow/profile/booking_confirmed/booking_confirmed_view_model.dart';

class BookingConfirmedPage extends StatefulWidget {
  const BookingConfirmedPage({super.key});

  @override
  BookingConfirmedPageState createState() => BookingConfirmedPageState();
}

class BookingConfirmedPageState extends State<BookingConfirmedPage> {
  late BookingConfirmedPageViewmodel viewModel;
  bool isNotificationOn = true;

  @override
  void initState() {
    super.initState();
    viewModel = BookingConfirmedPageViewmodel();
    viewModel.init();
  }
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => BookingConfirmedPageViewmodel(),
      child: Scaffold(
        body: Stack(
          children: [
            Positioned(

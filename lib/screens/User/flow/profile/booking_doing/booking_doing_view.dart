...
import 'package:saloon_app/screens/User/flow/profile/booking_doing/booking_doing_view_model.dart';

class BookingDoingView extends StatefulWidget {
  const  BookingDoingView({super.key});

  @override
   BookingDoingViewState createState() =>  BookingDoingViewState();
}

class BookingDoingViewState extends State<BookingDoingView> {
  late BookingDoingViewmodel viewModel;
  bool isNotificationOn = true;

  @override
  void initState() {
    super.initState();
    viewModel = BookingDoingViewmodel();
    viewModel.init();
  }
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => BookingDoingViewmodel(),
      child: Scaffold(
        body: Stack(
          children: [
            Positioned(
